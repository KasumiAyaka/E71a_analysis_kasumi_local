...
int do_hts2beta_one(std::string file_in_data, std::string file_out_data, int arg, int flg) {
	...
	if (arg == 0 && flg == 2)	command << "_hts2beta_v2.exe " << file_out_data << "\\beta_thick_0.dat -alternate0 --outputformat 1 -removeoutofrange  -ignorelackfile --volcut {\\\"Space\\\":[1000],\\\"Th\\\":[8]}";
	else if (arg == 0)	command << "_hts2beta_v2.exe " << file_out_data << "\\beta_thick_0.dat -alternate0 --outputformat 1 -removeoutofrange  -ignorelackfile --volcut {\\\"Space\\\":[1000],\\\"Th\\\":[8]}";
	else if (arg == 1 && flg == 2)command << "_hts2beta_v2.exe " << file_out_data << "\\beta_thick_1.dat -alternate1 --outputformat 1 -removeoutofrange  -ignorelackfile --volcut {\\\"Space\\\":[1000],\\\"Th\\\":[8]}";
	else if (arg == 1)command << "_hts2beta_v2.exe " << file_out_data << "\\beta_thick_1.dat -alternate1 --outputformat 1 -removeoutofrange  -ignorelackfile --volcut {\\\"Space\\\":[1000],\\\"Th\\\":[8]}";
	else if (arg == 2)	command << "_hts2beta_v2.exe " << file_out_data << "\\beta_thin_0.dat -thin16_base --outputformat 1 -removeoutofrange  -ignorelackfile --volcut {\\\"Space\\\":[1000],\\\"Th\\\":[8]}";
	...
	else if (arg == 3 && flg == 1)	command << "_hts2beta_v2.exe " << file_out_data << "\\beta_thin_1.dat -thin16_outer --outputformat 1 -removeoutofrange  -ignorelackfile --volcut {\\\"Space\\\":[1000],\\\"Th\\\":[8]}";
	else if (arg == 3)	command << "_hts2beta_v2.exe " << file_out_data << "\\beta_thin_1.dat -thin16_outer --outputformat 1 -removeoutofrange  -ignorelackfile --volcut {\\\"Space\\\":[1000],\\\"Th\\\":[8]}";
	else {
